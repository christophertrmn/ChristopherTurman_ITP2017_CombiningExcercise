...
namestr=5
namelevel=1
monsterlist=["Uler Kadut","Arden Pejuang Bangsa","uler uleran","Sexy Boiz","Magnificient Fashion BOIZ", "One Punch Minaldi", "Tante Vero", "Bagus sang Manusia Millenium", "Aldi sang penakluk dunia"]
